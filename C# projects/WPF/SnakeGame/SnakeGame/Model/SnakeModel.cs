...
namespace SnakeGame.Model
{
    ...
    public class SnakeModel
    {
        ...
        private readonly List<FigShapes> Snake;
        private readonly FigShapes Food;
        ...
        /// <summary>
        /// Játéktábla méret lekérdezés.
        /// </summary>
        public MapSize GetMapsize() { return _fieldSize; }
        ...
        public SnakeModel(ISnakeDataAccess dataAccess)
        {
            ...
            _gameDirection = Direction.goRight; //kigyó kezdő indulási iránya
